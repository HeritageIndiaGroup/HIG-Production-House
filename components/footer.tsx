...
export function Footer() {
  const services = [
    { name: "Film Shooting", href: "/services/film-shooting" },
    { name: "Short Films", href: "/services/short-films" },
    { name: "Wedding films & Pre/Post wedding Shoot", href: "/services/wedding-films" },
    { name: "Commercial Product Shoot", href: "/services/commercial-shoot" },
    { name: "Music Videos", href: "/services/music-videos" },
    { name: "Photography and Event Coverage", href: "/services/photography" },
    { name: "Ad Films", href: "/services/ad-films" },
    { name: "Corporate Films and Documentaries", href: "/services/corporate-films" },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <Link href="https://www.facebook.com/" target="_blank" className="text-background/70 hover:text-primary transition-colors">
                <Facebook className="w-5 h-5" />
              </Link>
              <Link href="https://www.instagram.com/p/DOL4XLej7UD/?igsh=MXNqa3R0YmQ3MzNjNw==" target="_blank" className="text-background/70 hover:text-primary transition-colors">
                <Instagram className="w-5 h-5" />
              </Link>
              <Link href="https://www.youtube.com/" target="_blank" className="text-background/70 hover:text-primary transition-colors">
                <Youtube className="w-5 h-5" />
              </Link>
              <Link href="https://www.twitter.com/" target="_blank" className="text-background/70 hover:text-primary transition-colors">
                <Twitter className="w-5 h-5" />
              </Link>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {services.map((service) => (
                <li key={service.name}>
                  <Link href={service.href} className="text-background/80 hover:text-primary transition-colors">
                    {service.name}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-2">
                <MapPin className="w-4 h-4 text-primary mt-0.5 flex-shrink-0" />
                <span className="text-background/80">
                  Heritage India Agro Producer Company, Tea Estate, Near Durga Temple, Banjarawala Chowk, Dehradun 248001
                </span>
              </li>
              <li className="flex items-center space-x-2">
                <Phone className="w-4 h-4 text-primary flex-shrink-0" />
                <span className="text-background/80">+91 76188 78887</span>
              </li>
              <li className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-primary flex-shrink-0" />
                <span className="text-background/80">admin@higproductionhouse.com</span>
